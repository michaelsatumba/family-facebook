	...
	return (
		<div className="min-h-screen bg-gray-900">
			...
			<div className="mt-2 bg-gray-700">
				...
				>
					<label className="flex flex-col items-center rounded-lg tracking-wide uppercase cursor-pointer bg-white hover:bg-blue-500 hover:text-white text-blue-500 px-16">
						<svg
							className="w-8 h-8"
							fill="currentColor"
